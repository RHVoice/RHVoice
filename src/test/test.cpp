...
int main(int argc,const char* argv[])
{
  try{
      ...
      std::string quality_argStor{"std"};
      ...
      TCLAP::ValueArg<std::string> quality_arg("q","quality","quality",false,"std","quality",cmd);
#endif
     ...
     try{
      ...
      eng->configure("quality", GET_CLI_PARAM_VALUE(quality_arg));
