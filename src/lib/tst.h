...
typedef int (*tst_enum_callback)(const uint8_t *key,size_t len,void *value,void *user_data);
void tst_enum_prefixes(tst tree,const uint8_t *key,tst_enum_callback callback,void *user_data);
#endif
