...
public final class Data
{
    ...
    static
    {
        ...
        lang.addVoice(new VoicePack("leticia_f123", "Let\u00Edcia-F123", lang, 4, 3, Checksums.VOICE_LETICIA, "https://public.f123.org/download/RHVoice-Brazilian-Portuguese-voice-Leticia-F123-v4.3.zip", null));
        addLanguage(lang);
}
